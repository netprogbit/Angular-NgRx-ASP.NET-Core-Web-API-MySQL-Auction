...
namespace LogicLayer.Helpers
{
    public static class FileHelper
    {
        ...
        public static async Task UpdateImageAsync(IFormFile file, string oldFileName, string newFileName)
        {
            ...
            {
                DeleteFile(oldFileName); // Detele old image file
            }
        }
        ...
        public static void DeleteFile(string fileName)
        {
            ...
            string fullFileName = Path.Combine(Path.Combine(WebRootPath, _imageFolderName), fileName);
        ...
        {
            return Path.Combine(Path.Combine(WebRootPath, _imageFolderName), fileName);
        }
